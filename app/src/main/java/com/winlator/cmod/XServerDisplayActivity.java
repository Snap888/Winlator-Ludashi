...
public class VRProfile {
    ...
    public void loadFromEffect(VREffect effect) {
        ...
        // Загружаем gyroMode
        this.gyroMode = effect.getGyroMode();
    }
    ...
    public void applyToEffect(VREffect effect) {
        ...
        // Применяем gyroMode
        effect.setGyroMode(this.gyroMode);
    }
    ...
    public void resetToDefaults() {
        ...
        // Сброс gyroMode
        this.gyroMode = 0; // По умолчанию для фреймов
    }
    ...
    // Геттеры и сеттеры для gyroMode - НОВОЕ
    public int getGyroMode() {
        return gyroMode;
    }

    public void setGyroMode(int gyroMode) {
        this.gyroMode = Math.max(0, Math.min(1, gyroMode));
    }
    ...
    public static VRProfile fromJSON(JSONObject json) throws JSONException {
        ...
        // Загружаем gyroMode
        profile.gyroMode = json.getInt("gyroMode");
        return profile;
    }
}